...
filepath_StudentsInfo_processed = '../../data/CH/Student/1.StudentInfo.csv'

filepath_AttendenceInfo = '../../data/kaoqin.csv'

filepath_StudentsScore = '../../data/5_chengji.csv'

filepath_StudentsConsumption = '../../data/consumption.csv'

filepath_StudentsConsumption_Processed = '../../data/CH/Student/5.Consumption.csv'
...
def data_preprocess_studentInfo():
    ...
    # 保存
    data_StudentInfo.to_csv('../../data/CH/Student/1.StudentInfo.csv', encoding='utf_8_sig')
    print('文件保存完成！')
