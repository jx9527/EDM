...
def ascendTree(prefixPath,leafNode):  # ascends from leaf node to root

    if leafNode.parent != None:
        prefixPath.append(leafNode.name)
        ascendTree( prefixPath,leafNode.parent)
...
def mineTree(inTree, headerTable, minSup, preFix, freqItemList):
    ...
    for basePat in bigL:  # start from bottom of header table
        ...
        if myHead != None and len(newFreqSet)==1:  # 3. mine cond. FP-tree
...
#     print(item)
print (findPrefixPath('B4', myHeaderTab['B4'][1]))
